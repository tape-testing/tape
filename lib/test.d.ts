...
declare class Test extends EventEmitter {
    ...
    capture<T extends Test.Callback>(this: Test, obj: Record<PropertyKey, unknown>, method: PropertyKey, implementation?: T): Test.WrapResults;
    end(this: Test, err?: unknown): void;
    fail(this: Test, msg: string, extra?: AssertOptions): void;
    intercept(this: Test, obj: Record<PropertyKey, unknown>, property: PropertyKey, desc?: PropertyDescriptor): Test.InterceptResults;
