...
= function (a, b, msg, extra) {
    this._assert(a < b, {
        message : defined(msg, 'should be less than'),
        operator : 'lessThan',
        actual : a,
        expected : '< ' + b,
        extra : extra
...
= function (a, b, msg, extra) {
    this._assert(a > b, {
        message : defined(msg, 'should be greater than'),
...
= function (a, b, msg, extra) {
    this._assert(a <= b, {
        message : defined(msg, 'should be less than or equal'),
...
= function (a, b, msg, extra) {
    this._assert(a >= b, {
        message : defined(msg, 'should be greater than or equal'),
